           ...
           @include('pages.category_brand')
                ...
                <div class="features_items"><!--features_items-->
                    <h2 class="title text-center">Features Items</h2>
                     ...
                     <?php foreach($all_product_by_category as $product_by_category) {?>
                            ...
                            <div class="product-image-wrapper">
                                ...
                                <div class="choose">
                                    <ul class="nav nav-pills nav-justified">
                                        ...
                                        <li><a href="{{URL::to('/view-product/'.$product_by_category->product_id)}}"><i class="fa fa-plus-square"></i>View Product</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
